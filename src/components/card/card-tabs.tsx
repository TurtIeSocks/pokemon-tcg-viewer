			...
			{TABS.map((t) => {
				...
				return (
					<button
						...
						className={cn(
							"relative rounded-t-(--r-control) border px-4 py-2 font-mono text-[11px] uppercase tracking-[0.12em] transition-all duration-200 ease-(--ease)",
							"focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-(--primary)",
							active
								? "z-10 border-b-0 border-white/12 bg-(--glass-2) text-(--ink) shadow-[inset_0_1px_0_rgba(255,255,255,0.22)] backdrop-blur-xl"
